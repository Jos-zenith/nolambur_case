...
class GraphData(Data):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.loss_fn = 'ce'
        self.num_nodes = int(self.x.shape[0]) if self.x is not None else 0
    ...
    def add_ports(self):
        ...
        out_ports = [ports(self.edge_index.flipud(), adj_list_out)] if reverse_ports and self.edge_index is not None else []
...
def z_norm(data: torch.Tensor) -> torch.Tensor:
